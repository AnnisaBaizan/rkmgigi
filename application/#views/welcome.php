...
<html lang="en">
  ...
  <body>
    <div class="container">
<div id="login" class="signin-card" style="text-align:center">
  ...
  <form action="<?php echo site_url('login/cariadmin');?>" method="POST" class="" role="form">
    <div>
      <a href="<?=base_url('login/loginmahasiswa');?>"><button class="btn btn-block btn-danger ripple-effect" type="button" name="mahasiswa" alt="Mahasiswa">Mahasiswa</button></a>
	</div>
	<br />	
	<div>
      <a href="<?=base_url('login/logindosen');?>"><button class="btn btn-block btn-primary ripple-effect" type="button" name="dosen" alt="Dosen">Dosen</button></a>
	</div>
	<br />	
	<div>
      <a href="<?=base_url('login/loginadmin');?>"><button class="btn btn-block btn-success ripple-effect" type="button" name="operator" alt="Operator">Operator</button></a> 
	</div>
