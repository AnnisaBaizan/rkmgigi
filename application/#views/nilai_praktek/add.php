    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            ...
            <div class="body">
                ...
                <?php echo form_open('nilai_praktek/add'); ?>
                    <div class="row clearfix"><div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                ...
                                <label for="nik" class="control-label">Nama Pasien</label>
                                <div class="form-group">
                                    <div class="form-line">
					...
					<div class="row clearfix"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <select name="kd_sub_aspek" class="form-control" data-live-search="true">
                                            <option value="">Pilih</option>
                                            <?php 
                                            foreach($all_sub_aspek as $sub_aspek)
                                            {
                                                $selected = ($sub_aspek['id_sub_aspek'] == $this->input->post('kd_sub_aspek')) ? ' selected="selected"' : "";
					...
					<div class="row clearfix">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="date" name="tanggal_praktek" value="<?php echo $this->input->post('tanggal_praktek'); ?>" class="form-control" id="tanggal_praktek" />
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" name="angka_perolehan" value="<?php echo $this->input->post('angka_perolehan'); ?>" class="form-control" id="angka_perolehan" />
                                </div>
                            </div>
                        </div></div>
					<div class="row clearfix">
					...
					<div class="row clearfix">
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <select name="validasi_dosen" class="form-control">
                                            ...
                                            {
                                                $selected = ($value == $this->input->post('validasi_dosen')) ? ' selected="selected"' : "";
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="date" name="tanggal_validasi" value="<?php echo $this->input->post('tanggal_validasi'); ?>" class="form-control" id="tanggal_validasi" />
                                </div>
                            </div>
                        </div>
						-->
