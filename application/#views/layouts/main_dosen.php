            ...
            <aside id="leftsidebar" class="sidebar">
                ...
                <div class="user-info">
                    ...
                    <div class="info-container">
                        <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo strtoupper($_SESSION['nama_dosen']); ?></div>
                        <div class="email"><?php echo strtoupper(($_SESSION['level_dosen'] == '1' ? 'Dosen' : 'Kaprodi')); ?></div>
                ...
                <div class="menu">
                    <ul class="list">
                        ...
                        <?php echo ($this->uri->segment(1) == 'dosen_mahasiswa' ? "<li class='active'>" : "<li>"); ?>
                            <a href="<?php echo site_url('dosen_mahasiswa/index'); ?>">
