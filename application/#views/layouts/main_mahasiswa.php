    ...
    <body class="theme-red">
        ...
        <nav class="navbar">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li>
                    <a href="https://simkesgi.poltekkespalembang.ac.id"
                       target="_blank"
            ...
            <aside id="leftsidebar" class="sidebar">
                ...
                <div class="user-info">
                    ...
                    <div class="info-container">
                        ...
                        <?php echo strtoupper($_SESSION['nim_mhs']); ?>
                        </div>
                        <div class="email"><?php echo strtoupper($_SESSION['nama_mhs']); ?></div>
                ...
                <div class="menu">
                    <ul class="list">
                        ...
                        <?php echo ($this->uri->segment(1) == 'nilai_mahasiswa' ? "<li class='active'>" : "<li>"); ?>
                            <a href="<?php echo site_url('nilai_mahasiswa/index'); ?>">
                                <i class="material-icons">perm_identity</i>
                                <span>Nilai</span>
                            </a>
                        </li>
                        <?php echo ($this->uri->segment(1) == 'pasien_mahasiswa' ? "<li class='active'>" : "<li>"); ?>
                            <a href="<?php echo site_url('pasien_mahasiswa/index'); ?>">
                                <i class="material-icons">person_pin</i>
                                <span>Pasien</span>
                            </a>
                        </li>
                        <?php echo ($this->uri->segment(1) == 'password_mahasiswa' ? "<li class='active'>" : "<li>"); ?>
                            <a href="<?php echo site_url('password_mahasiswa/index'); ?>">
