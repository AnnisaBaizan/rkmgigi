        ...
        <div class="card">
            <div class="header">
                ...
                <div class="header-dropdown">
					...
					<a href="<?php echo site_url('nilai/add'); ?>" class="btn btn-primary btn-sm">Tambah Nilai</a>
                </div>
            </div>
            <div class="body table-responsive">
                <table id="data-table-simple" class="responsive-table display" cellspacing="0">
                    ...
                    <tr>
						...
						<td>
							<a href="<?php echo site_url('nilai/index/'.$t['nim']); ?>" class="btn btn-primary btn-xs"><span class="fa fa-file"></span> Nilai</a>
                        </td>
                    </tr>
                    <?php } ?>
					</tbody>
