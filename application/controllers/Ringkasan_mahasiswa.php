...
class Ringkasan_mahasiswa extends CI_Controller{
    ...
    {   
        ...
        {   
			...
			if($this->input->post('kode_dosen', TRUE)<>""){
				$pencarian .= " and a.kode_dosen=? ";				
				array_push($value, $this->input->post('kode_dosen', TRUE));
			}
			...
			*/
            ...
            $data['_view'] = 'ringkasan_mahasiswa/index';
	...
	function nilai($nim=null, $ta=null){
		...
		$data['_view'] = 'ringkasan_mahasiswa/nilai';
	...
	function detail($nim=null, $kd_sub_praktikum=null, $ta=null){
		...
		$data['_view'] = 'ringkasan_mahasiswa/detail';
		$data['judulform'] = 'DETAIL NILAI MAHASISWA';
		$this->load->view('layouts/main',$data);
	}
