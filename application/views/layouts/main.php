        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                ...
                <div class="info-container">
                    <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <?php echo strtoupper($_SESSION['username_admin']); ?></div>
                    <div class="email"><?php echo ($_SESSION['level_admin'] == 'su' ? 'Super User' : 'Operator'); ?>
                    </div>
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <?php echo ($this->uri->segment(1) == 'pendaftaran_praktikum' ? "<li class='active'>" : "<li>"); ?>
                    <a href="<?php echo site_url('pendaftaran_praktikum/add'); ?>">
                        <i class="material-icons">assessment</i>
                        <span>Pendaftaran Praktikum</span>
                    </a>
                    </li>

                    <?php if ($_SESSION['level_admin'] <> 'pendaftaran') { //su dan operator yang diizinkan ?>
                        <?php echo ($this->uri->segment(1) == 'ringkasan_mahasiswa' ? "<li class='active'>" : "<li>"); ?>
                        <a href="<?php echo site_url('ringkasan_mahasiswa/index'); ?>">
                            <i class="material-icons">supervisor_account</i>
                            <span>Ringkasan Mahasiswa</span>
                        </a>
                        </li>
                        <?php echo ($this->uri->segment(1) == 'ringkasan_pasien' ? "<li class='active'>" : "<li>"); ?>
                        <a href="<?php echo site_url('ringkasan_pasien/index'); ?>">
                            <i class="material-icons">supervisor_account</i>
                            <span>Ringkasan Pasien</span>
                        </a>
                        </li>
                        ...
                        <?php if ($_SESSION['level_admin'] == 'su') {
                            echo ($this->uri->segment(1) == 'admin' ? "<li class='active'>" : "<li>"); ?>
                    ...
                    <?php } //akhir filter su dan operator yang diizinkan ?>
