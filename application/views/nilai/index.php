							...
							<?php 
								foreach($all_nilai as $nilai){
									echo "<tr>
										...
										<td>"; ?>
										<a href="<?php echo site_url('nilai/detail/'.$nilai['nim'].'/'.$nilai['id_sub_praktikum'].'/'.$nilai['id_konf']); ?>" class="btn btn-primary btn-xs"><span class="fa fa-search"></span> Detail</a>
										<a href="<?php echo site_url('nilai/prints/'.$nilai['nim'].'/'.$nilai['id_sub_praktikum'].'/'.$nilai['id_konf']); ?>" target="_blank" class="btn btn-danger btn-xs"><span class="fa fa-print"></span> Print</a>
										<?php 
										echo "</td>
									</tr>";
								}
