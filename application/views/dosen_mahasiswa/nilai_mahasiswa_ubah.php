<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		...
		<div class="card">
            ...
            <div class="body">
			<?php echo form_open("dosen_mahasiswa/nilai_mahasiswa_simpan_ubah"); ?>
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<label for="diagnosa" class="control-label">Diagnosa Pasien</label>
						<div class="form-group">
							<div class="form-line">
								<input type="text" name="diagnosa" value="<?php echo ($diagnosa['diagnosa'] ? $diagnosa['diagnosa'] : ''); ?>" class="form-control" required  />
							</div>
						</div>
					</div>
					<div class="row clearfix">
							...
							<?php 
								...
								foreach($sub_aspek as $nilai){
									echo "<tr>
										...
										<td>
										<input type='text' name='angka_perolehan$no' class='form-control' id='angka_perolehan' required value='$nilai[angka_perolehan]' />
										<input type='hidden' name='id_nilai_praktek$no' class='form-control' id='id_nilai_praktek' required value='$nilai[id_nilai_praktek]' />
										</td>
									</tr>";
									$no++;
								}
