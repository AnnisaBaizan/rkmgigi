							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	                            ...
	                            <div class="form-group">
	                                <div class="form-line">
										...
										<textarea id="editor1" name="diagnosa" class="form-control" required ><?php echo ($info['diagnosa'] ? $info['diagnosa'] : $this->input->post('diagnosa')); ?></textarea>
									</div>
								</div>
							</div>
					</div>
...
<?php 
	$qnilai = number_format((($nilaiakhir/$bobot)*100),2);
	$this->db->query("UPDATE tbl_praktikum_mahasiswa 
	SET nilai=?, status='Y'
	WHERE id_daftar_praktikum=? and nim=? and kode_dosen=?", array($qnilai, $qkd_daftar_praktikum, $qnim, $_SESSION['kode_dosen']));
?>
<script>
