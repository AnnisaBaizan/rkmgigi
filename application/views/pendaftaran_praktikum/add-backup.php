    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            ...
            <div class="body">
				...
				<!-- <form method="POST" action="<?php echo base_url();?>pendaftaran_praktikum/add"  enctype="multipart/form-data"> -->
                    <div class="row clearfix">
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="form-group">
                                <div class="form-line">
									<input type="file" name="diagnosa_odontogram" class="form-control" required />
								</div>
                            </div>
						</div>
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="form-group">
                                <div class="form-line">
									<textarea id="editor1" name="diagnosa_pasien" class="form-control" required><?php echo ($this->input->post('diagnosa_pasien') ? $this->input->post('diagnosa_pasien') : ''); ?></textarea>
                ...
                <?php echo form_close(); ?>  
				<!-- <hr>
				<h4>Pencarian Praktikum</h4>
				<?php echo form_open('pendaftaran_praktikum/add'); ?>
                    <div class="row clearfix">
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<label for="tanggal_praktek" class="control-label">Masukkan Tanggal Praktek</label>
                            <div class="form-group">
                                <div class="form-line">
									<input type="date" name="tanggal_praktek_cari" value="<?php echo ($this->input->post('tanggal_praktek_cari') ? $this->input->post('tanggal_praktek_cari') : date('Y-m-d')); ?>" class="form-control" required />
								</div>
                            </div>
						</div>
					</div>
				...
				<div class="body table-responsive">
					<!-- <table id="data-table-simple" class="responsive-table display" cellspacing="0">
						...
						<tr>
							...
							<td> 
								<a href="<?php echo site_url('pendaftaran_praktikum/remove/'.$t['id_daftar_praktikum']); ?>" class="btn btn-danger btn-xs"><span class="fa fa-trash"></span> Delete</a>
							</td>
						</tr>
						<?php $no++; } ?>
						</tbody>
