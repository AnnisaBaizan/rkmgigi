            ...
            <div class="body table-responsive">
                <table id="data-table-simple" class="responsive-table display" cellspacing="0">
                    ...
                    <tr>
						...
						<td>
                            <a href="<?php echo site_url('pasien_mahasiswa/view/'.$t['id_pasien']); ?>" class="btn btn-success btn-xs btn-block"><span class="fa fa-eye"></span> View</a>  
                            <a href="<?php echo site_url('pasien_mahasiswa/edit/'.$t['id_pasien']); ?>" class="btn btn-info btn-xs btn-block"><span class="fa fa-pencil"></span> Edit</a> 
                        </td>
                    </tr>
                    <?php } ?>
					</tbody>
