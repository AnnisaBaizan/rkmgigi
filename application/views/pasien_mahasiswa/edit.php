    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            ...
            <div class="body">
				...
				?>
				<?php echo form_open('pasien_mahasiswa/edit/'.$pasien['id_pasien']); ?>
					...
					<div class="row clearfix">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="form-group">
                                <div class="form-line">
									<input type="date" name="tanggal_lahir_pasien" value="<?php echo ($this->input->post('tanggal_lahir_pasien') ? $this->input->post('tanggal_lahir_pasien') : $pasien['tanggal_lahir_pasien']); ?>" class="form-control" id="tanggal_lahir_pasien" />
								</div>
                            </div>
						</div>
					</div>
