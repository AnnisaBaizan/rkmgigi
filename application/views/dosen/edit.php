            ...
            <div class="body">
				...
				<?php echo form_open('dosen/edit/'.$dosen['id_dosen']); ?>
					...
					<div class="row clearfix">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="form-group">
                                <div class="form-line">
									<input type="text" name="kode_dosen" value="<?php echo ($this->input->post('kode_dosen') ? $this->input->post('kode_dosen') : $dosen['kode_dosen']); ?>" class="form-control" id="kode_dosen" readonly />
								</div>
                            </div>
						</div>
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					...
					'P'=>'Perempuan',
										...
										{
											$selected = ($value == $dosen['jk']) ? ' selected="selected"' : "";
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<label for="level" class="control-label">Level Petugas</label>
							<div class="form-group">
								<div class="form-line">
					...
					'2'=>'Kaprodi',
										...
										{
											$selected = ($value == $dosen['level']) ? ' selected="selected"' : "";
