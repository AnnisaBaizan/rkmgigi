							...
							<?php 
								...
								foreach($all_nilai as $nilai){
									...
									echo "<tr>
										...
										<td>"; ?>
										<a href="<?php echo site_url('ringkasan_nilai_mahasiswa/detail/'.$nilai['nim'].'/'.$nilai['kd_sub_praktikum'].'/'.$nilai['kd_konfigurasi']); ?>" class="btn btn-primary btn-xs"><span class="fa fa-search"></span> Detail</a>
										<?php 
										echo "</td>
									</tr>";
