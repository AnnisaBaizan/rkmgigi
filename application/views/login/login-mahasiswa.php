...
<div id="login" class="signin-card">
  ...
  <h1 class="display1">Login Mahasiswa</h1>
  <p class="subhead">Sistem Penilaian Praktek Gigi</p>
  <form action="<?php echo site_url('login/carimahasiswa');?>" method="POST" class="" role="form">
    ...
    <div>
      <button class="btn btn-block btn-danger ripple-effect" type="submit" name="Submit" alt="sign in">Sign in</button>  
	  </div>
