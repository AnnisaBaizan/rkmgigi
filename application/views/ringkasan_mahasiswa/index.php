    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            ...
            <div class="body">
                ...
                <?php echo form_open('ringkasan_mahasiswa/index'); ?>
                    <div class="row clearfix">
				...
				<div class="body table-responsive">
					<table id="data-table-simple" class="responsive-table display" cellspacing="0">
						...
						<tr>
							...
							-->
							<td> 
								<a href="<?php echo site_url('ringkasan_mahasiswa/nilai/'.$t['nim'].'/'.$t['kd_konfigurasi']); ?>" target="_blank" class="btn btn-info btn-xs"><span class="fa fa-search"></span> Nilai</a>
							</td>
						</tr>
						<?php $no++; } ?>
						</tbody>
